...
- Name: catalog.spec.ts >> Catalog >> clicking a product navigates to product detail
- Location: e2e\catalog.spec.ts:41:3
...
Call log:
  - waiting for locator('article, [data-testid=\'product-card\']').first()
    - locator resolved to <a data-discover="true" href="/products/mock-3" data-testid="product-card" class="group block cursor-pointer overflow-hidden rounded-2xl border border-zinc-200 bg-white shadow-sm transition hover:border-zinc-300 active:scale-[0.99]">…</a>
