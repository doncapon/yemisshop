...
import { Check, ChevronDown, ChevronRight, CreditCard } from "lucide-react";
import { Link } from "react-router-dom"; // ✅ FIX (router Link)
        ...
        <td className="px-3 py-3 font-mono">
          <div className="flex items-center gap-2">
            {hasItems ? (
              ...
              <span className="inline-flex items-center justify-center w-6 h-6 rounded-md border text-zinc-300">
                •
              </span>
            )}
            <span>{tx.id}</span>
