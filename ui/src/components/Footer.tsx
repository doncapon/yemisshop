...
export default function Footer() {
  ...
  return (
    <footer className="bg-surface-alt border-t border-[--color-surface-ring] text-ink mt-10">
      <div className="max-w-7xl mx-auto px-3 sm:px-4 md:px-8 py-6 sm:py-8">
        {/* Top: brand + summary */}
        <div className="flex flex-col gap-4 sm:gap-5">
          <div className="flex items-center gap-2">
            <Link to="/" className="inline-flex items-center gap-2">
              <span className="inline-grid place-items-center w-8 h-8 rounded-xl bg-primary-600 text-white text-xs font-semibold">
                DS
              </span>
              <span className="font-semibold text-base sm:text-lg">DaySpring</span>
            </Link>
          </div>
        ...
        {/* Links + Newsletter */}
        <div className="mt-6 flex flex-col gap-6 sm:gap-8 md:grid md:grid-cols-12 md:gap-10">
          {/* Link columns */}
          <div className="md:col-span-7 lg:col-span-8">
            <div className="grid grid-cols-2 sm:grid-cols-3 gap-5">
              <div>
                <h3 className="text-xs sm:text-sm font-semibold mb-2 sm:mb-3">Shop</h3>
              ...
              <div>
                <h3 className="text-xs sm:text-sm font-semibold mb-2 sm:mb-3">Support</h3>
                <ul className="space-y-1.5 text-xs sm:text-sm text-ink-soft">
              ...
              <div>
                <h3 className="text-xs sm:text-sm font-semibold mb-2 sm:mb-3">Company</h3>
                <ul className="space-y-1.5 text-xs sm:text-sm text-ink-soft">
          ...
          <div className="md:col-span-5 lg:col-span-4">
            <div className="rounded-xl border border-[--color-surface-ring] bg-surface p-3.5 sm:p-4">
              <div className="flex flex-col gap-2.5">
                <div>
                  <h4 className="text-sm font-semibold">Get deals &amp; updates</h4>
                ...
                >
                  <input
                    ...
                    className="border rounded-lg px-3 py-2 text-xs sm:text-sm w-full outline-none focus:ring-2 ring-primary-300"
                    required
                  />
                  <button
                    type="submit"
                    className="rounded-lg px-3 py-2 text-xs sm:text-sm bg-primary-600 text-white hover:bg-primary-700 transition w-full sm:w-auto"
                  >
                    Subscribe
                  </button>
                </form>
        ...
        <div className="mt-6 sm:mt-8 pt-4 sm:pt-5 border-t border-[--color-surface-ring] flex flex-col sm:flex-row items-start sm:items-center gap-2.5 sm:gap-3 justify-between text-[10px] sm:text-xs md:text-sm text-ink-soft">
          <p>© {year} DaySpring. All rights reserved.</p>
