...
type EmployeeDocumentKind = "PASSPORT" | "NIN_SLIP" | "TAX" | "CONTRACT" | "OTHER";
...
export default function AdminEmployeeDocuments() {
  ...
  const [selectedKind, setSelectedKind] = useState<EmployeeDocumentKind>("PASSPORT");
  ...
  const { data, isLoading, isError, refetch, isFetching } = useQuery<DocumentsResponse>({
    queryKey,
    queryFn: async () => {
      if (!employeeId) {
          ...
          <div className="flex items-center gap-2">
            ...
            <div>
              ...
              <p className="text-[11px] sm:text-xs text-ink-soft">
                Upload and manage HR documents for this employee (passport, NIN,
                tax, contracts…).
              </p>
